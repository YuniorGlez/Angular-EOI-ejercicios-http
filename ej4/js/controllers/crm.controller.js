    ...
    function CRMController($scope, CustomersHTTP) {
        ...
        function createNewCustomer() {
            if (customerCompleted()) {
                ...
                // TODO: Invoca aquí el add de la factoría, recuerda que ahora añadimos
                // simplemente el nuevo usuario asi que pásaselo a la factoria
        ...
        function updateCustomer(customer) {
            ...
            // TODO: Aquí tendremos que hacer un update
            ...
            if (confirmation == customer.name) {
                $scope.customers.forEach(function (customerToRemove, idx) {
                    if (customer.id == customerToRemove.id) {
                        ...
                        // TODO: Aquí tendremos que hacer un remove
                    }
                });
            }
